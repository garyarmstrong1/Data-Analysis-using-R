...
#Loading the dataset and storing it as movies variable##
movies <- read.csv("movies.csv", stringsAsFactors = FALSE)
description <- read.csv("description.csv", stringsAsFactors = FALSE)
#print(str(movies))
#print(str(description))
##To check weather the dataset was loaded without any errors
...
server <- function(input, output, session) {
  ...
  observeEvent(input$show_data, {
    if(input$show_data){
      showTab(inputId = "tabspanel", target = "Plot and Data", select = TRUE)
    } else {
      hideTab(inputId = "tabspanel", target = "Plot and Data")
    }
  })
  
  # Render data table for description
